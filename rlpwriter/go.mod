module code.cloudfoundry.org/loggregator-tools/rlpwriter
...
require (
	...
	code.cloudfoundry.org/go-loggregator v7.1.0+incompatible // indirect
	...
	code.cloudfoundry.org/loggregator v0.0.0-20181105182727-76fe1d2a9ecd
